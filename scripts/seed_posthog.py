...
import httpx
from seed_demo import S1_SHIP, S2_SHIP, S3_SHIP, SEEDS  # shared spec + HogQL queries

from pm_agent.config import get_settings
from pm_agent.integrations.posthog import run_hogql

SHIP_BY_KEY = {"S1": S1_SHIP, "S2": S2_SHIP, "S3": S3_SHIP}
EXPECTED_LIFT = {"S1": 12.0, "S2": 1.0, "S3": 9.9}
